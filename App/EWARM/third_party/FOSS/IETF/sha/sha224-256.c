 ...
 *   sha Error Code.
 */
__weak int SHA256Reset(SHA256Context *context)
{
 ...
 *   sha Error Code.
 */
__weak int SHA256Input(SHA256Context *context, const uint8_t *message_array,
    unsigned int length)
{
  if (!length)
    return shaSuccess;
 ...
 *   sha Error Code.
 */
__weak int SHA256FinalBits(SHA256Context *context,
    const uint8_t message_bits, unsigned int length)
{
  ...
  static const uint8_t markbit[8] = {
 ...
 *   sha Error Code.
 */
__weak int SHA256Result(SHA256Context *context, uint8_t Message_Digest[])
{
