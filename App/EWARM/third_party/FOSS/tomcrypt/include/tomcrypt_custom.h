...
#define CFG_CRYPTO_AES
#define CFG_CRYPTO_GCM
#define LTC_RIJNDAEL

#define LTC_BASE64
#define LTC_CLEAN_STACK
#define LTC_GCM_32BITLEN
#define LTC_GCM_MODE
#define LTC_NO_ASM
...
#define TAB_SIZE (1) /* We need only one slot, for AES. */
...
/* macros for various libc functions you can change for embedded targets */
   ...
   #define LTC_NO_PROTOTYPES
   #endif
extern void *stz_ltc_malloc(size_t);
#define XMALLOC  stz_ltc_malloc
#endif
#ifndef XREALLOC
   #ifdef realloc 
   #define LTC_NO_PROTOTYPES
...
#define XCALLOC  calloc
   ...
   #define LTC_NO_PROTOTYPES
   #endif
extern void stz_ltc_free(void *);
#define XFREE    stz_ltc_free
#endif
