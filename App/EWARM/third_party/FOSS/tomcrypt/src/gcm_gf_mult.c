...
/**
  ...
  STz addition:
  Give this function "weak" linkage so that SoC code can override it
  if hardware crypto acceleration for GCM multiplication is available.
*/
__weak void gcm_gf_mult(const unsigned char *a, const unsigned char *b, unsigned char *c)
{
