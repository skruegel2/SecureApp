...
/*
 * STZ Change: We don't use the rijndael_desc struct, so don't waste ROM space.
 */
#if 0
...
/*
 * STZ Change: Add the "weak" linker attribute so that SoC-specific code can
 * override with a h/w accelerated AES implementation.
 */
__weak const struct ltc_cipher_descriptor aes_desc =
{
    "aes",
    6,
    16, 32, 16, 10,
